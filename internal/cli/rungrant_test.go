...
func TestRequestRunGrantSendsLayerMountsAndOwnPID(t *testing.T) {
	...
	requestRunCompatVia(c, &out, runMountsGrant(mounts...), nil, nil, 4242)
...
func TestRequestRunGrantNeverPromptsALockedSession(t *testing.T) {
	...
	var out bytes.Buffer
	requestRunCompatVia(c, &out, runMountsGrant("/tmp/fixture/.env"), nil, nil, 4242)
...
func TestRequestRunGrantSilentWhenAgentUnreachableOrRefusing(t *testing.T) {
	...
	var out bytes.Buffer
	requestRunCompatVia(dead, &out, runMountsGrant("/tmp/fixture/.env"), nil, nil, 4242)
	if out.Len() != 0 {
...
func TestRequestRunCompatDefaultSwapsAndAutodetectsLive(t *testing.T) {
	...
	var out bytes.Buffer
	requestRunCompatVia(c, &out, runMountsSwap("/tmp/fixture/.env"), nil, nil, 7777)
