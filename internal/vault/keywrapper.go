...
// Pillar II. internal/keychainwrap (the login keychain; prompted local
// authentication, not OS-enforced access control, RFC.md B9) and
// internal/secureenclave (the MEK sealed to a Secure Enclave key) implement
// it; internal/keystore chooses one per vault.
