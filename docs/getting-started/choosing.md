...
description: When to use jit wrap, jit run, jit run --profile, and how a migrated .env stays compatible with your scripts.
---
...
- **Default — compatibility swap.** Each mount becomes a plain, inert
