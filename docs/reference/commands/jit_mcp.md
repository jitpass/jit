...
* [jit mcp install](jit_mcp_install.md)	 - Add jit's MCP server to Claude Desktop
* [jit mcp status](jit_mcp_status.md)	 - Show whether Claude Desktop can reach jit's MCP server
* [jit mcp uninstall](jit_mcp_uninstall.md)	 - Remove jit's MCP server from Claude Desktop
