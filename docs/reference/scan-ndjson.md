...
| `vault_secrets_checked` | how many vault secrets a deep scan looked for, after leaving out values the exact-string index will not search for (too short, all digits). Absent on a regular scan (schema 0.23.0+) |
